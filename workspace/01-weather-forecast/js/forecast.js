...
export const getCurrentPosition = function() {
    navigator.geolocation.getCurrentPosition(function(posicao) {
        ...
        ajax(`https://nominatim.openstreetmap.org/reverse?lat=${latitude}&lon=${longitude}&format=json`,
...
const getCityId = (cityName, state) =>
    ajax(`https://apiadvisor.climatempo.com.br/api/v1/locale/city?name=${cityName}&state=${state}&token=${CLIMATEMPOTOKEN}`,
